...
def decrypt_single_msg(cyclic_group: CyclicGroup, cipher_message: CipherMessage, s_key: object) -> object:
...
def main():
    ...
    decrypted_message = decrypt_single_msg(group, encrypted_message, TTP_key.s_key)
